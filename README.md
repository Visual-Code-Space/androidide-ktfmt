# ktfmt fork (androidide-ktfmt)

This fork aims to make some simple changes so that we can add ktfmt into [AndroidIDE](https://github.com/Visual-Code-Space/AndroidIDE)  
